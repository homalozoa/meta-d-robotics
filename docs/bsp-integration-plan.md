...
| 40-pin control and overlays | `hobot-io`, pinmux overlays and GPIO/SPI/I2C/UART/PWM helpers | Official Python GPIO API and source-built production overlays implemented; protected enable/disable workflow pending | Python import/pin map, overlay round trip, reboot persistence, GPIO line test and one test per enabled bus |
